...
export default function FloatingLines({
    ...
    useEffect(() => {
        ...
        // append to the *captured* element (not ref.current) so we don't race unmount
        ...
        // ✅ FIX: guard against ref becoming null during resize / route transitions
        const setSize = () => {
            if (!mounted) return;
        ...
        JSON.stringify(topWavePosition ?? null),
        JSON.stringify(middleWavePosition ?? null),
        JSON.stringify(bottomWavePosition ?? null),
        animationSpeed,
        interactive,
        bendRadius,
        bendStrength,
    ...
    return (
        <div
            ...
            style={{ mixBlendMode, pointerEvents, opacity }}
            aria-hidden="true"
        />
    );
}
